...
const endpoints = getApiEndpoints();
    ...
    var endpoint = type === 'automation' 
      ? getValidatedEndpoint(endpoints,'Email Automation Rules')
      : getValidatedEndpoint(endpoints,'Email Rule details');

Domain Domain = Domain + '/<REDACTED_PATH>/' + Domain + Domain;
...
// records.forEach(rec => {
//   Object.keys(rec).forEach(key => headersSet.add(key));
// });
...
extractJSONAndAppendHeaders(records, deptSheet);
