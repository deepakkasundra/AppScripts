...
const endpoints = getApiEndpoints();
  ...
  var apiUrl = mono_domain + getValidatedEndpoint(endpoints,'MONO CM API Version') + BOTID + getValidatedEndpoint(endpoints,'MONO CM ticketing form');
...
Domain Domain = Domain + '/<REDACTED_PATH>/' + Domain + '/<REDACTED_PATH>/' + Domain;
