...
const url = dashboardDomain + getValidatedEndpoint(endpoints,'Fetch Webview URL') + botID + getValidatedEndpoint(endpoints,'Fetch Webview URL endpoint');
...
ss.setActiveSheet(sheet);
     ...
     const errorMessage = 'Error fetching data from the API: ' + e.message + '\n\nPlease check API EndPoint';
 ...
 // Browser.msgBox(e.message, Browser.Buttons.OK);
     ...
     const errorMessage = 'Error in fetchAndStoreWebViewURLs: ' + e.message + '\n\nPlease check API EndPoint';
